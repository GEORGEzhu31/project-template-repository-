...
- The driver with the most points is the `driver's champion`(The Official Home of Formula E).
...
##All Seasons
```{r, model1,visualize, echo=FALSE, fig.width=8}
...
```{r,model2, visualize, echo=FALSE, fig.width=8}
...
---
##Frequecny >=3
```{r, model3, visualize, echo=FALSE, fig.width=8}
...
##First Six Seasons & Frequency>=3
```{R, model4, visualize, echo=FALSE, fig.width=8}
