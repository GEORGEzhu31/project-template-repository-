...
## Who has won the game in the last few years, and what factors influenced their performance.
...
- The team with the most team points* out of the 10 teams is the team champion.

.footnote[[*]The points of the team's two drivers add up to the team's total]

---

# Drivers' Championships in Six Seasons
...
kable(head(best_drivers_summary), format = "html")
```
