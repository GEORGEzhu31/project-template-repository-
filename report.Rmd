...
During the initial stage of data cleansing, functions such as group_by(), select(), slice(), filter(), and summarize () play a pivotal role. These functions meticulously shape and refine the raw data into a structured and coherent format. Moreover, they also help merge information needed such as average points. These data frames, encompassing driver details, total points, average points, and frequency derived from FERR0, lay the groundwork for subsequent analytical endeavors.
...
Model 1 is based on the original dataset FERR and specifically establishes the positive correlation between the participation frequency and the average scores of all drivers over the past seven seasons. 
```{r model1, echo=FALSE}
#frequency
freq <- 
  select(FERR, driver)  %>% 
