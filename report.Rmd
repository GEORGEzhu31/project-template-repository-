...
## Conclusion
This report aims to demonstrate that the number of races the drivers participate in has a moderate positive effect on the points they earn. The analysis started with tidying and summarizing, inspired an initial idea about potential relationships can be explored from the dataframes. Further works involved modeling, visualizing and evaluating. A linear regression model was used to predict the relationship between the frequency of participation and the average score of individual drivers. The r-squared value of the model was improved from 0.44 to 0.53 by removing detected outliers.The Limitations of the model, such as potential bias and reduced sample size, were also discussed. The findings of this study is expected to bring some possible inspirations to the field of events. For instance, team managers who aim to optimize their drivers’ performance.
