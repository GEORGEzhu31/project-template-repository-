...
The table below excerpts data from the most representative Season 2, with new variables such as frequency (number of race participation), total_points (cumulative points), and avg_points (average points) being added.
